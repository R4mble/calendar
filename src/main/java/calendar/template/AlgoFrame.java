...
//
//            AlgoVisHelper.drawText(g2d, "2019-" + data.getMonth() + "-" + data.getDay()
//                    , 400, 100);
//
//            AlgoVisHelper.drawText(g2d, weekdayMap.get(data.getWeekday()), 400, 130);
//
...
//                }
//                AlgoVisHelper.drawText(g2d, data.getDate(i + 1), 20, 60 + 70 * i, 450);
//            }
//
//        }
//
